...
<body>
  ...
  <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container">
        <a class="navbar-brand" href="index.php"><img src="img/android-chrome-192x192.png" height="45px"></a>
...
<br>
    ...
    <div class="row mb-4">
      <div class="col-md-8">
        <p>Why trust descriptions? Get it now and see for yourself - installation is quick and simple. </p>
      </div>
      <div class="col-md-4">
        <a class="btn btn-lg btn-secondary btn-block" href="download.php">Get it now</a>
      </div>
    </div>
